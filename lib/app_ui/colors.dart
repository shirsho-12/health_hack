...
/// Defines the color palette for the HHack UI.
abstract class HHackColors {
  /// Black
  ...
  /// Primary
  static const Color primary = Color(0xFF7F6890);

  /// Secondary
  static const Color secondary = Color(0xFFC5D4AB);

  /// Tertiary
  static const Color accent = Color(0xFFFCE8B8);
