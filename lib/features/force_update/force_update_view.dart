...
class _ForceUpdateViewState extends State<ForceUpdateView> {
  ...
  void initState() {
    super.initState();
    viewModel = ServiceLocator.get<ForceUpdateViewModelProtocol>(
      param: widget.isRequiredUpdate,
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(foregroundColor: Colors.red),
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Spacer(),
              const Center(child: Icon(Icons.logo_dev_rounded, size: 200)),
