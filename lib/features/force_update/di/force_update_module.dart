...
class ForceUpdateModule extends AppModule {
  ...
  void registerDependencies() {
    ...
    ServiceLocator.registerFactory<GetMinimumVersionUseCaseProtocol>(() {
      return GetMinimumVersionUseCase(
        route: ServiceLocator.get<ForceUpdateRoutesProtocol>(),
      );
    });
    ...
    ServiceLocator.registerLazySingleton<ForceUpdateProtocol>(() {
      return ForceUpdate(
        ...
        getMinimumVersionUseCase:
            ServiceLocator.get<GetMinimumVersionUseCaseProtocol>(),
      );
    });

    ServiceLocator.registerFactoryParam<ForceUpdateViewModelProtocol, bool>((
      isRequiredUpdate,
    ) {
